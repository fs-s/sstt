<template>
  <img src="https://store.cloudflare.steamstatic.com/public/images//gift/steamcards_promo_02.png" alt="" srcset="">
      ...
      <div class="text-gray-500 flex flex-col text-left ml-24 mt-40 text-xs">KINKEKAARDID
        <a href="#" class="text-blue-500 hover:text-white">Nüüd Olemas Steamis</a>
    </div>
    <div class="text-gray-500 flex flex-col text-left ml-24 my-5 text-xs">SOOVITATUD
    ...
    <div class="text-gray-500 flex flex-col text-left ml-24 my-5 text-xs">AVASTUS JÄRJEKORD
        <a href="#" class="text-blue-500 hover:text-white">Soovitused</a>
        <a href="#" class="text-blue-500 hover:text-white">Uued Väljalased</a>
    </div>
    <div class="text-gray-500 flex flex-col text-left ml-24 my-5 text-xs">SIRVI KATEGOORIAID
    ...
    <div class="text-gray-500 flex flex-col text-left ml-24 my-5 text-xs">SIRVI ZANRI JÄRGI
    ...
    <div class="text-gray-500 flex flex-col text-left ml-24 my-5 text-xs">VIIMATI VAADATUD
